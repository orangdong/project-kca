...
<div class="card card-body">
	...
	<select name="toko" id="toko-select" onchange="changeToko()" required data-control="select2" data-placeholder="-" class="form-select form-select-solid form-select-lg fw-bold select2-hidden-accessible">
		<option value=""></option>
    ...
    <ul>
        <li class="d-flex align-items-center py-2">
            ...
            <a href="#" id="user-btn" class="btn btn-secondary">
        ...
        <li class="d-flex align-items-center py-2">
            <span class="bullet me-5"></span>
            <a href="#" id="view-barang-btn" class="btn btn-secondary">
        ...
        <li class="d-flex align-items-center py-2">
            <span class="bullet me-5"></span>
            <a href="#" id="barang-btn" class="btn btn-secondary">
                <!--begin::Svg Icon | path: icons/duotone/Shopping/Box2.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="d-flex align-items-center py-2">
            <span class="bullet me-5"></span>
            <a href="#" id="metode-btn" class="btn btn-secondary">
                ...
                <!--end::Svg Icon--> 
            Edit Metode Pembayaran</a>
        </li>
        <li class="d-flex align-items-center py-2">
            <span class="bullet me-5"></span>
            <a href="#" id="riwayat-btn" class="btn btn-secondary">
...
<script>
    const tokoSelect = document.getElementById('toko-select')
    function changeToko() {
        document.getElementById('user-btn').href = '{{route('edit-user')}}' + '?id=' + tokoSelect.value
        document.getElementById('barang-btn').href = '{{route('edit-barang')}}' + '?id=' + tokoSelect.value
        document.getElementById('view-barang-btn').href = '{{route('view-barang')}}' + '?id=' + tokoSelect.value
        document.getElementById('metode-btn').href = '{{route('edit-metode')}}' + '?id=' + tokoSelect.value
        document.getElementById('riwayat-btn').href = '{{route('riwayat')}}' + '?id=' + tokoSelect.value
    }
</script>
