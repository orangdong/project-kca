				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
							...
							<form class="form w-100" novalidate="novalidate"  method="post" action="{{ route('login') }}">
								...
								<div class="fv-row mb-10">
									...
									<div class="d-flex flex-stack mb-2">
										...
										<!--end::Label-->
										<!--begin::Link-->
										<a href="/hubungiadmin" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
										<!--end::Link-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Input-->
					...
					<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
						...
						<div class="d-flex flex-center fw-bold fs-6">
							<a href="https://mmnatures.com" class="text-muted text-hover-primary px-2" target="_blank">Copyright &copy; 2021 PT Merpati Mahardika</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
